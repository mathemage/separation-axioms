...
\begin{frame}
\frametitle{Klasický případ v bodové topologii}
\begin{block}{Vztahy oddělovacích axiomů v~bodové topologii}
  \begin{align*}
    (T_4) \& (T_1)
...
\subsection{Axiom $T_0$} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
