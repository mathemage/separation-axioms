...
\newcommand{\HRule}{\rule{\linewidth}{0.5mm}}  % přidal Duc Trung Ha
...
bezbodová topologie, separační axiomy, locale, frame
...
pointless topology, pointfree topology, separation axioms, locale, frame
