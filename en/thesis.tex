...
%his helpful comments, constructive criticism, excellent tutoring and, above
...
%
%Last but not least, I would like to pay tribute to my patient mentors at~Charles
%University in~Prague for guiding me through the thorny path of~academic life
%and enabling me to truly develop as a~person.
...
The classical (point-set) topology concerns points and their neighborhoods.
If we neglect points and consider only the structure of open sets, we obtain
a~complete lattice satisfying the distributive law $b \wedge \bigvee A =
\bigvee \{ b \wedge a \st a\in A \}$.
Such lattices are called ``frames'' or ``locales'' and they are cornerstones
