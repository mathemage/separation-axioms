...
The classic (point-set) topology concerns points and their neighborhoods.
...
Such lattices are called ``frames'' and ``locales'';
and they are the cornerstones of~point-free topology.
...
This thesis focuses on~the series of~$T$-axioms:
...
In~the course of~the text we study their point-free counterparts and how they
relate to~each other.
In~the end we notice that the situation for them is almost same as in~classic
topology.
