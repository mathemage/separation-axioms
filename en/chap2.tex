...
\begin{proof}
  ...
  Since $\nabla$ is onto, $\alpha$ is a~frame homomorphism, as well.
  % by \ref{TBD}
  Finally,
  \[
    \nabla \alpha \nabla(U)
    ...
    = \nabla (U)
  \]
  (by a~standard property of Galois adjoints $\nabla \Delta (0) \le 0$), that
  is, $\nabla \alpha = id$.
  Hence, $\alpha$ and $\nabla$ are mutually inverse isomorphisms, and TBD
\end{proof}
