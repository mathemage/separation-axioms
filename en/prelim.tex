...
\begin{itemize}
\item A~map~$h\colon A \to B$ between algebras $A$ and $B$ \emph{preserves
operation $\rho$\/} (or \emph{commutes with $\rho$\/}) if $h( \rho(\,
(a_i)_{i\in J}\, ) ) = \rho(\, (h(a_i))_{i\in J}\, )$ for any system
$(a_i)_{i\in J}$ TBD

%\item A~map~$h\colon A \to B$ between algebras $A$ and $B$ is
%a~\emph{homomorphism\/}
\end{itemize}
