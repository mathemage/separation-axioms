...
\]
is a closed sublocale (recall \ref{cor:closed-sloc} on
page~\pageref{cor:closed-sloc}\thinspace).
...
\begin{proof}
  ...
  Thus it is an~epimorphism by~Fact~\ref{fct:onto->epic} on
  page~\pageref{fct:onto->epic}\thinspace.
